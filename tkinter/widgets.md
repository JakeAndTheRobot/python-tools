...
| [`Label`](#Label)            | A widget that displays text or an image                                                          |
| [`Entry`](#Entry)            | A single-line text field for entering input                                                      |
| [`Text`](#Text)             | A multi-line text field for entering and displaying large amounts of text                        |
| [`Checkbutton`](#Checkbutton)      | A widget that displays a checkbox that can be checked or unchecked                              |
| [`Radiobutton`](#Radiobutton)      | A widget that displays a radio button that can be selected as part of a group                   |
| [`Listbox`](#Listbox)          | A widget that displays a list of items that can be selected                                     |
| [`Menu`](#Menu)             | A widget that displays a menu of options                                                        |
| [`Scale`](#Scale)            | A widget that displays a sliding scale for selecting a value                                     |
| [`Canvas`](#Canvas)           | A widget that provides a drawing surface for displaying graphics and images                     |
| [`Frame`](#Frame)            | A container widget that can be used to group other widgets together                             |
